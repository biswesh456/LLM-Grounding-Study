...
print("###############Repair###############")
df = pd.read_csv("/home/bmohapat/github/LLM-Grounding-Study/data/perplexity/files_for_testing/uncertainty_dataset_perplexity_testing_dataset.csv")

# # For cases other than anaphora and uncertainty
...
correct_count = 0
for i in range(len(correct_ppl)):
    if correct_ppl[i] < wrong_ppl[i]:
        correct_count += 1
...
df.to_csv("uncertainty_d1_perplexity_testing_dataset_final_checked_with_llama.csv")
